...
class ServerNode:
    ...
    def chat(self):
        ...
        while connected:
            ...
            encrypted = encryption.rsa(encryption.rsa(message, SERVER_PRIVATE_KEY), CLIENT_PUBLIC_KEY)
            ...
            try:
                ...
                output = encryption.rsa(encryption.rsa(cipher, SERVER_PRIVATE_KEY), CLIENT_PUBLIC_KEY)
